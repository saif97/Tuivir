            ...
            let resources = listing
                ...
                .map(|row| {
                    ...
                    Resource {
                        ...
                        // `sbx exec` could host one, but which shell a sandbox
                        // should open, and whether an agent's sandbox is a
                        // place to put a user, are questions this Provider has
                        // not been asked yet. Until it is, the operation is
